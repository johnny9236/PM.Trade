...
namespace PM.ALiPtlBiz.Ali
{
    public class AlipaySubmit
    {
        //#region 字段
        ////支付宝网关地址（新）
        //private   string GATEWAY_NEW = string.Empty;//"https://mapi.alipay.com/gateway.do?";
        ////商户的私钥
        ...
        //#endregion
        public AliConfig Cfg { get; set; }

        public AlipaySubmit(AliConfig cfg)
        {
            Cfg = cfg;
        }
        ...
        private   string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            //把最终的字符串签名，获得签名结果
            string mysign = "";
            switch (Cfg.Sign_type)
            {
                case "MD5":
                    mysign = AlipayMD5.Sign(prestr, Cfg.Key, Cfg.Input_charset);
                    break;
                default:
                    mysign = "";
                    break;
        ...
        private   Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            sPara.Add("sign_type", Cfg.Sign_type);
        ...
        public   string BuildRequest(SortedDictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            ...
            sbHtml.Append("<form id='alipaysubmit' name='alipaysubmit' action='" + Cfg.GATEWAY_NEW + "_input_charset=" + Cfg.Input_charset + "' method='" + strMethod.ToLower().Trim() + "'>");
        ...
        {
            Encoding code = Encoding.GetEncoding(Cfg.Input_charset);
            ...
            //构造请求地址
            string strUrl = Cfg.GATEWAY_NEW + "_input_charset=" + Cfg.Input_charset;
        ...
        {
            string url = Cfg.GATEWAY_NEW + "service=query_timestamp&partner=" + Cfg.Partner + "&_input_charset=" + Cfg.Input_charset;
            string encrypt_key = "";
