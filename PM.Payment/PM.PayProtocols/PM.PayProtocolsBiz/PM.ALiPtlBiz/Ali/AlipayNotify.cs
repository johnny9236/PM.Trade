...
namespace PM.ALiPtlBiz.Ali
{
    public class AlipayNotify
    {
        ...
        public AlipayNotify(AliConfig cfg)
        {
            Cfg = cfg;
        }
        /// <summary>
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            if (sign != null && sign != "")
            {
                ...
                {
                    case "MD5":
                        isSgin = AlipayMD5.Verify(preSignStr, sign, Cfg.Key, Cfg.Input_charset);
                        break;
                    default:
                        break;
                }
        ...
        {
            string veryfy_url = Cfg.VerifyUrl + "&partner=" + Cfg.Partner + "&notify_id=" + notify_id;
