...
namespace PM.PaymentProtocolModel.BankCommModel.TRCB
{
    ...
    /// 退款操作
    /// </summary>
    public class TRCBRefundRequset : CommunicationBase
    {
        /// <summary>
        /// 交易代码
        /// </summary>
        ...
        /// 对象明细
        /// </summary>
        public List<TRCBRefundInfo> TRCBRefundList { get; set; }
           /// <summary>
        /// 获取报文数据
        /// </summary>
        /// <returns></returns>
        public virtual string GetMessagePaket()
        {
            ...
            foreach (var bank in TRCBRefundList)
            {
                #region 明细
                sb.Append("<BanK>");
                sb.Append("<BankNo>");
