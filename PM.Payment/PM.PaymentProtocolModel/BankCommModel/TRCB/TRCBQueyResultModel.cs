...
namespace PM.PaymentProtocolModel.BankCommModel.TRCB
{
    ...
    /// 入账明细查询返回
    /// </summary>
    public class TRCBQueyResultModel
    {
        /// <summary>
        /// 交易代码
        /// </summary>
        ...
        /// 明细列表
        /// </summary>
        public List<TRCBQueryInfo> TRCBQueryList { get; set; }
        /// <summary>
        /// 获取明细对象
        /// </summary>
        ...
        public virtual bool GetModel(string packetString)
        {
            ...
            try
            {
                ...
                if (bankList != null && bankList.Count() > 0)
                    this.TRCBQueryList = new List<TRCBQueryInfo>();
