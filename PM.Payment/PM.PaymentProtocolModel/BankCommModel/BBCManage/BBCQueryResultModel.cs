...
namespace PM.PaymentProtocolModel.BankCommModel
{
    ...
    /// 入账明细查询返回
    /// </summary>
    public class BBCQueyResultModel
    {
        /// <summary>
        /// 交易代码
        /// </summary>
        ...
        /// 明细列表
        /// </summary>
        public List<BBCQueryInfo> BBCQueryList { get; set; }
        /// <summary>
        /// 获取明细对象
        /// </summary>
        ...
        public virtual  bool GetModel(string packetString)
        {
            ...
            try
            {
                ...
                if (bankList!=null&&bankList.Count() > 0)
                    this.BBCQueryList = new List<BBCQueryInfo>();
                foreach (var bank in bankList)
                {
                    var dtl = new BBCQueryInfo();
                    ...
                    this.BBCQueryList.Add(dtl);
                }
            }
            catch (Exception ex)
            {
                rst = false;
                LogTxt.WriteEntry("异常信息:" + ex.Message, "青阳入账明细");
                throw ex;
            }
            return rst;
        }
