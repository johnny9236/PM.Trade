...
namespace PM.PaymentProtocolModel.BankCommModel
{
    ...
    /// 退款明细查询
    /// </summary>
    public class BBCQueryRtnResultModel
    {
        /// <summary>
        /// 交易代码
        /// </summary>
        ...
        /// 明细列表
        /// </summary>
        public List<BBCQueryInfo> BBCRtnQueryList { get; set; }
        /// <summary>
        /// 获取明细对象
        /// </summary>
        ...
        public virtual  bool GetModel(string packetString)
        {
            ...
            try
            {
                ...
                if(bankList!=null&&bankList.Count()>0)
                    this.BBCRtnQueryList=new List<BBCQueryInfo>();
