...
namespace PM.PaymentProtocolModel.BankCommModel
{
    ...
    /// 退款操作
    /// </summary>
    public class ICBCRefundRequset : CommunicationBase
    {
        ...
        public List<ICBCRefundInfo> ICBCRefundList { get; set; }
        ...
        public virtual string GetMessagePaket()
        {
            ...
            foreach (var bank in ICBCRefundList)
            {
                #region 明细
                sb.Append("<BanK>");
                sb.Append("<BankNo>");
            ...
            var strCount = PM.Utils.StringHelper.Text_Length(sendInfo);
