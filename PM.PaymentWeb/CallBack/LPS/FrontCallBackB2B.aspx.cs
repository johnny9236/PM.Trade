...
public partial class CallBack_LPS_FrontCallBackB2B : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            LogTxt.WriteEntry(string.Format("返回报文为空，报文[{0}-----{1}--{2}]", message, signStr,parmStr), "b2B前台通知日志");
            return;
        }
        //  支付返回
